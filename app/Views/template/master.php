...
<head>
    ...
    <title>Admin K3519058 - Dashboard</title>
    ...
    <script src="<?= base_url('/assets/js/sb-admin-2.js'); ?>" crossorigin="anonymous"></script>
    <script src="<?= base_url('/assets/js/sb-admin-2.min.js'); ?>" crossorigin="anonymous"></script>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Admin K3519058</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href=" <?php echo base_url('/button'); ?>">Buttons</a>
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form method="GET" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                        <div class="input-group">
                            ...
                            <!-- <input type="text" class="form-control bg-light border-0 small" name="cari" placeholder="Mencari Data Berdasarkan Nama">
